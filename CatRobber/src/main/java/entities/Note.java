...
// Записка з одним текстом, реалізує необхідні інтерфейси
public class Note implements GameObject, Interactable {
    // Поля
    private Vector2D position; // Позиція, з defaultData/saveData (x, y)
    private String text; // Текст записки, з defaultData/saveData
    ...
    public Note(JSONObject defaultData) {
    ...
    // Методи Renderable
    // Малює записку, отримує GraphicsContext від GameManager
    @Override
