...
// Комп’ютер, що показує код для головоломки, реалізує необхідні інтерфейси
public class Computer implements GameObject, Interactable {
    // Поля
    private Vector2D position; // Позиція, з defaultData/saveData (x, y)
    private String code; // Код для головоломки, з defaultData/saveData
    ...
    public Computer(JSONObject defaultData) {
    ...
    // Методи Renderable
    // Малює комп’ютер, отримує GraphicsContext від GameManager
    @Override
    ...
    // Методи Interactable
    // Відкриває UI з кодом, передає code в UIManager
    @Override
